...
/**
 * @file maLibSQL.php
 * Ce fichier définit les fonctions de requêtage, vers une base de donnée MySQL
...
function SQLGetChamp($sql, $array)
{
	global $BDD_host;
	global $BDD_base;
	global $BDD_user;
