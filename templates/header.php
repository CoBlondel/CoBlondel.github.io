...
<div id="wrap">
  ...
  <div class="navbar navbar-inverse">
	...
	<a class="navbar-brand" href="index.php?view=galerie">Galerie</a>
      </div>
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
         	<!-- <li class="active"><a href="index.php?view=galerie">Accueil</a></li> -->
		<?php
		...
		if (valider("connecte","SESSION"))
		{
			...
			echo mkHeadLink("Nous contacter","contact",$view);
